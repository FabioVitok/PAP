...
class ProductController
{
    ...
    public function findProductById(int $productId) {
        try {
            ...
            $pai = (new ProductPaiDAO())->findProductPaiById($product->getIdProdutoPai());
    ...
    public function getProductsByPaiId(int $productPaiId) {
        try {
            $products = (new ProductDAO())->findByPaiId($productPaiId);
