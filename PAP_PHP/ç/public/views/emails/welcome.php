                                                        ...
                                                        <tr>
                                                            <td align="center" bgcolor="#ffffff" role="presentation"
                                                                ...
                                                                <a href="{{LINK}}" style="text-decoration:none;">
                                                                    <p
                                                                        style="display:inline-block;background:#ffffff;color:#212020;font-family:Times New Roman, Helvetica, Arial, sans-serif;font-size:18px;font-weight:normal;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 25px;mso-padding-alt:0px;border-radius:3px;">
                                                                        Verificar
                                                                    </p>
                                                                </a>
                                                            </td>
