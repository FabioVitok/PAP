...
('Flared distress Jeans', "38", 0.70, "Calças", "Preto", 29.99, 15.10, 10),
('Flared distress Jeans', "40", 0.75, "Calças", "Preto", 29.99, 15.20, 10),
('Flared distress Jeans', "42", 0.80, "Calças", "Preto", 29.99, 15.30, 10),
('Flared distress Jeans', "44", 0.85, "Calças", "Preto", 29.99, 15.40, 10),
('Flared distress Jeans', "46", 0.90, "Calças", "Preto", 29.99, 15.50, 10);

INSERT INTO produtos(nome, tamanho, peso, tipo, cor, preco_venda, preco_custo, stock) VALUES
('Distressed Scarf', "Único", 0.20, "Acessório", "Preto", 15.50, 5.00, 10),
('Eyelet Lace Bag', "Único", 0.20, "Acessório", "Preto", 25.99, 15.00, 10),
('Snake Belt', "Único", 0.15, "Acessório", "Preto", 19.99, 10.00, 10),
('Eyelet kerchief', "Único", 0.10, "Acessório", "Preto", 12.99, 5.00, 10);
